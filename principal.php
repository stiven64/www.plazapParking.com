                                ...
                                <div class="row">
                                    ...
                                    foreach($mapeos as $mapeo){
                                        ...
                                        if($estado_espacio == "LIBRE"){ ?>
                                            <div class="col">
                                                <center>
                                                    ...
                                                    <button class="btn btn-dark" style="width: 101%;height: 114px"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="button" class="btn btn-warning" id="btn_reservar<?php echo $id_map;?>">Reservar</button>
                                                                    <script>
                                                                        $('#btn_reservar<?php echo $id_map;?>').click(function () {
                                        ...
                                        if($estado_espacio == "OCUPADO"){ ?>
                                            ...
                                            <?php
                                        }elseif($estado_espacio == "RESERVADO"){ ?>
                                            <div class="col">
                                                <center>
                                                    <h2><?php echo $nro_espacio;?></h2>
                                                    <button class="btn btn-info" id="btn_ocupado<?php echo $id_map;?>" data-toggle="modal"
                                                                    ...
                                                                    <script>
                                                                        $('#btn_cambiar_ocupado<?php echo $id_map;?>').click(function () {
                                                                            ...
                                                                            $.get(url, {cuviculo: cuviculo}, function (datos) {
                                                                                ...
                                                                                $('#btn_ocupado<?php echo $id_map;?>').attr('data-target', '');
                                                                                $('#btn_ocupado<?php echo $id_map;?>').removeAttr('data-toggle');
                                                                                $('#btn_ocupado<?php echo $id_map;?>').attr('disabled', true);
                                                                                $('#btn_ocupado<?php echo $id_map;?>').attr('class', 'btn btn-success');
                                                                                $('#btn_ocupado<?php echo $id_map;?>').html('Ocupado');
